            ...
            <article className="container shadow-lg mx-auto bg-purple-100 rounded-lg">
                <header className="relative">
                    <div className="absolute h-full w-full flex items-center justify-center p-8">
                        <div className="bg-white bg-opacity-75 rounded p-12">
                            ...
                            <div className="flex justify-center text-gray-800">
                                <img src={urlFor(singlepost.authorImage).url()} alt={singlepost.name} className="w-10 h-10 rounded-full"></img>
                    ...
                    <div className="px-16 lg:px-48 py-12 lg:py-20 prose lg:prose-xl max-w-full">
                        <BlockContent blocks={singlepost.body} projectId="r4dlfd4p" dataset="production" />
                    </div>
            </article>
        </main>
    )
