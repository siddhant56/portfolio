    ...
    return (
        <main className="bg-blue-100 min-h-screen p-12">
            <section className="container mx-auto">
                ...
                <h2 className="text-lg text-gray-600 flex justify-center mb-12">Welcome to page of blog post</h2>
                    ...
                    <Link to={"/post/"+post.slug.current} key={post.slug.current}>
                        <span className="block h-64 relative rounded shadow leading-snug bg-white border-l-8 border-green-400" key={index}>
                            ...
                            <span className="block relative h-full flex justify-center items-end pr-4 pb-4">
                                <h3 className="text-gray-800 text-lg font-bold px-3 py-4 bg-purple-500 text-purple-100 bg-opacity-75 rounded">
                                {post.title}
                                </h3>
                            </span>
                        </span>
